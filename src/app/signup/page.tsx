    ...
    <div className="bg-black w-full h-screen">
      <section>
        <div className="flex items-center justify-center px-4 py-10 sm:px-6 sm:py-16 lg:px-8 lg:py-24 max-md:mt-[60px] ">
          <div className="xl:mx-auto xl:w-full xl:max-w-sm 2xl:max-w-md pt-[80px] max-md:w-full">
            ...
            <p className="mt-2 text-center text-base text-gray-400">
              ...
              <Link href={'/login'} className="font-medium transition-all duration-200 hover:underline text-sky-500">Sign In</Link>
